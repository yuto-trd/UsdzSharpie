...
namespace UsdzSharpie.Server
{
    public class MeshRenderer : IDisposable
    {
        ...
        public MeshRenderer(AssimpMesh mesh, Matrix4? transform = null)
        {
            Transform = transform ?? Matrix4.Identity;
            Color = mesh.Material?.DiffuseColor ?? new Vector3(0.8f, 0.8f, 0.8f);
            ...
            if (mesh.Indices != null && mesh.Indices.Length > 0)
            {
                ...
                // Convert uint[] to int[] for OpenGL
            ...
            Console.WriteLine($"MeshRenderer created from AssimpMesh: {vertexCount} vertices, {indexCount} indices");
        }
